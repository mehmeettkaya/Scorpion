package com.mehmetkaya.scorpion.data.datasource

import com.mehmetkaya.scorpion.data.model.ProcessResult
...
import com.mehmetkaya.scorpion.utils.Constants
import com.mehmetkaya.scorpion.utils.PeopleGen
import com.mehmetkaya.scorpion.utils.RandomUtils
...
class PersonDataSource @Inject constructor(
    ...
    private fun processRequest(next: String?): ProcessResult<Person> {
        ...
        if (isError) {
            ...
            val nextIntValue = try { next!!.toInt() } catch (ex: Exception) { null }
